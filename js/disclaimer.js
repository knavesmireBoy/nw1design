...
/* eslint-disable max-len */
  ...
  const intro1 =
      "My colleague, Lylaani Dixon, has very kindly allowed me to repurpose one of her old sites as a playground for learning React. The existing site - maintained  largely for sentimental reasons - deploys an <a href='https://www.projectseven.com/support/updatepages/ssm.htm'>old dreamweaver javascript library</a> on the portfolio pages to deliver a rather complex gallery/slideshow/accordion that would provide a challenge to recreate both in React and pure ES6.",
    intro2 =
    ...
    intro3 =
      "This site is the pure JS version and my first written entirely with ES6 which I was keen to explore further before attempting the <a href='https://knavesmireboy.github.io/minchinhampton?cv/'>React</a> version. The chief difference is that the React version utilises the browsers' localStorage API and markdown-esque markup to perform rudimentary editing of the main content, mimicking the functionality of a full-blown CMS. I eschewed the use of &ldquo;create-react-app&rdquo; in order to gain some exposure to webpack and the modern JS ecosystem. Due to its primary focus the site will not degrade well in older browsers, although finally utilising SASS for the first time does help a little with the presentation layer. I will continue to use the site to explore further features of the framework, and in due course integrate a proper back-end. Lylanni has moved on from NW1 and her most recent endeavours can be <a href='https://parish-council.website'>found here</a>.";
