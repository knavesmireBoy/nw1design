...
/* eslint-disable max-len */
  ...
  const intro1 =
    ...
    intro3 =
      "This site is the <strong>pure JS</strong> version mostly written in ES6 which I was keen to explore further as a prelude to attempting the <a href='https://knavesmireboy.github.io/nw1design-react'>React</a> version. The chief difference is that the React version utilises the browsers' localStorage API and markdown-type markup to perform local style edits of the main article content, faking the functionality of a full-blown CMS. Due to its primary focus I have not catered for older browsers for this particular project.",
