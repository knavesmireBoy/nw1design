...
function prepareHeadings(ul) {
	...
	let headers = {};
		...
		loader = function() {
            //create sidebar
			compose(addImgLoad, setImg, setDiv, getParent, doH2, getParent, curry2(invoke)($q('#display ul')), prepend, addClickHover, addClickPreview, setNavId, append(doMake('section')()), prepend(contentarea), doMake('aside'))();
			...
			const getLinks = compose(curryL3(invokeMethodBridge)('map')((a) => a.getAttribute('href')), toArray, $$q('#navigation ul li a', true)),
